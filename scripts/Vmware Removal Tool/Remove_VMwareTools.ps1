...
# 
# Original Author: @broestls
# Original Source: https://gist.github.com/broestls/f872872a00acee2fca02017160840624
# 
# This script will manually rip out all VMware Tools registry entries and files for Windows 2008-2019
# Tested for 2019, 2016, and probably works on 2012 R2 after the 2016 fixes.
# 
# Modified version with syntax fix for Windows 10 compatibility
# 
# WARNING: This script will remove ALL VMware-related files and services, including VMware Workstation Pro
# If you only want to remove VMware Tools, consider using Windows "Add or Remove Programs" instead
#
# REQUIREMENTS:
# - Must be run as Administrator
# - Windows PowerShell 5.0 or later
# - Will require system reboot after completion
